...
<div align="left">
<form name="forme1" method="GET" action="<?php echo $_SERVER['PHP_SELF'];?>">
...
&nbsp;&nbsp;Size :&nbsp;
<input type="text" name="size" size="2" value="<?php  echo $_GET['size']; ?>">
&nbsp;&nbsp;Path to img/ :&nbsp;
<input type="text" name="pathtoimg" size="10" value="<?php echo $_GET['pathtoimg']; ?>">
...
<div align="left">
<form name="forme2" action="demo_conversion.php" method="get">
<TEXTAREA NAME="resultat" COLS="80" ROWS="10">
<?php
include("../mathpublisher.php") ;
$message=$_GET['message'];
$size=$_GET['size'];
$pathtoimg=$_GET['pathtoimg'];
